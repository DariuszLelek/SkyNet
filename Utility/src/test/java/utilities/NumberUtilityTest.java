...
public class NumberUtilityTest {
  ...
  public void tryGetNumbersFromWords() throws Exception {
    ...
    String instruction9 = "nine million nine hundred ninety nine thousand and nine hundred ninety nine";
    ...
    List<Long> result9 = NumberUtility.tryGetNumbersFromWords(Arrays.asList(instruction9.split(" ")));
    ...
    assertEquals((Long) 9999999L, result9.get(0));
  }
